...
class KBiAssociativeContainer
{
  ...
  struct _iterator_impl_ctor<QHash<T, U>, T, U> :
    public QHash<T, U>::iterator
  {
    /* implicit */
  ...
  template<typename T, typename U>
  struct _iterator_impl_ctor<QMap<T, U>, T, U> :
    public QMap<T, U>::iterator
  {
    /* implicit */
...
public:
  ...
  class _iterator :
    public _iterator_impl_ctor<Container, typename Container::key_type, typename Container::mapped_type>
  {
public:
...
private:
  ...
  const KBiAssociativeContainer<LeftContainer,
                                RightContainer>& operator=(const KBiAssociativeContainer<LeftContainer, RightContainer>& other)
  {
  ...
  friend QDataStream& operator<<<LeftContainer, RightContainer>(QDataStream & out, const KBiAssociativeContainer<LeftContainer,
                                                                                                                 RightContainer>& bihash);
  friend QDataStream& operator>><LeftContainer, RightContainer>(QDataStream & in,
...
template<typename T, typename U>
struct KBiHash :
  public KBiAssociativeContainer<QHash<T, U>, QHash<U, T> >
{
  KBiHash()
...
template<typename T, typename U>
struct KHash2Map :
  public KBiAssociativeContainer<QHash<T, U>, QMap<U, T> >
{
  KHash2Map()
