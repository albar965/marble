...
class GenericScanlineTextureMapper::RenderJob :
  public QRunnable
{
public:
...
GenericScanlineTextureMapper::RenderJob::RenderJob(StackedTileLoader *tileLoader, int tileLevel, QImage *canvasImage,
