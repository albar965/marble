...
class MercatorScanlineTextureMapper::RenderJob :
  public QRunnable
{
public:
...
MercatorScanlineTextureMapper::RenderJob::RenderJob(StackedTileLoader *tileLoader, int tileLevel, QImage *canvasImage,
