...
class MARBLE_EXPORT SearchRunnerManager :
  public QObject
{
  Q_OBJECT
...
public:
  ...
  QVector<GeoDataPlacemark *> searchPlacemarks(const QString& searchTerm, const GeoDataLatLonBox& preferred = GeoDataLatLonBox(),
                                               int timeout = 30000);
