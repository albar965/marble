...
cmake -Wno-dev -G "MinGW Makefiles" -DQTONLY=TRUE -DQT5BUILD=TRUE -DWITH_quazip=FALSE -DWITH_libshp=FALSE -DWITH_libgps=FALSE -DWITH_libwlocate=FALSE -DWITH_QtLocation=FALSE -DWITH_liblocation=FALSE -DCMAKE_INSTALL_PREFIX=%APROJECTS%\Marble-release -DCMAKE_BUILD_TYPE=Release ..\marble
...
xcopy %APROJECTS%\marble\src\lib\astro\*.h %APROJECTS%\Marble-release\include\astro
